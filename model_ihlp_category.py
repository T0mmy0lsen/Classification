...
categories = 6
data = IHLP().get(categories=categories)
...
def define_model(_kernel_size=3, _activation='relu', _input_dim=None, _output_dim=300, _max_length=None):
    ...
    outp = Dense(categories, activation='softmax')(conc)
...
for activation in activations:
    for kernel_size in kernel_sizes:
        ...
        for train, test in kfold.split(sentences):
            ...
            model = define_model(kernel_size, activation, _input_dim=vocab_size, _max_length=max_len)
